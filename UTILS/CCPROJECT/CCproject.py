...
class CCproject:
    ...
    def __init__(self, filename):
        ...
        self.fh_press = fh_press
        self.fh_temp = fh_temp
        self.velx = fh_velx
        self.vely = fh_vely
        self.velz = fh_velz
        self.vel = fh_vel
    ...
    def getData(self):
        return {'x': self.xzn0, 'time': self.time, 'density': self.fh_dens, 'pressure': self.fh_press,
                'temp': self.fh_temp, 'velx': self.velx, 'vely': self.vely, 'velz': self.velz,
