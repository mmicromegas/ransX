...
class ResProperties(calc.Calculus, al.SetAxisLimit, object):
    ...
    def properties(self, laxis, xbl, xbr):
        ...
        return {'tauL': tauL, 'kolm_tke_diss_rate': kolm_tke_diss_rate, 'tke_diss': diss, 'tke': tke, 'lc': lc,
                'uconv': uconv, 'xzn0inc': xzn0inc, 'xzn0outc': xzn0outc, 'tc': tc}
