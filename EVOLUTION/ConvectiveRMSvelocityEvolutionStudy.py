...
class ConvectiveRMSvelocityEvolutionResolutionStudy(Calculus, ALIMITevol, Tools, object):
    ...
    def plot_turms_evolution(self, LAXIS, xbl, xbr, ybu, ybd, ilg):
        ...
        if (LAXIS != 2):
            print("ERROR(ConvectiveRMSvelocityEvolutionStudy.py): Only LAXIS=2 is supported.")
            sys.exit()
