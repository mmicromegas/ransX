...
class EnergySourceTermEvolutionResolutionStudy(Calculus, ALIMITevol, Tools, object):
    ...
    def plot_tenuc_evolution(self, LAXIS, xbl, xbr, ybu, ybd, ilg):
        ...
        if (LAXIS != 2):
            print("ERROR(EnergySourceTermEvolutionStudy.py): Only LAXIS=2 is supported.")
            sys.exit()
