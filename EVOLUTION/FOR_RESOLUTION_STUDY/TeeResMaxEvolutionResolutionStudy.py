...
class TeeResMaxEvolutionResolutionStudy(uCalc.Calculus, uEal.ALIMITevol, uT.Tools, object):
    ...
    def plot_resTeeMax_evolution(self, LAXIS, xbl, xbr, ybu, ybd, ilg):
        ...
        if (LAXIS != 2):
            print("ERROR(TeeResMaxEvolutionResolutionStudy.py): Only LAXIS=2 is supported.")
            sys.exit()
