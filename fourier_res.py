...
import UTILS.FOURIER.FOR_RESOLUTION_STUDY.ResFourierReadParams as rp
import UTILS.FOURIER.FOR_RESOLUTION_STUDY.ResFourierMasterPlot as plot
import ast
import os

# create os independent path and read parameter file
paramFile = os.path.join('PARAMS', 'param.fourier.res')
params = rp.ResFourierReadParams(paramFile)

# instantiate master plot
plt = plot.ResFourierMasterPlot(params)
