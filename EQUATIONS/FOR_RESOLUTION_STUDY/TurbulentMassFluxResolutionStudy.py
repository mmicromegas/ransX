...
class TurbulentMassFluxResolutionStudy(Calculus, SetAxisLimit, Tools, Errors, object):
    ...
    def plot_fddx(self, LAXIS, xbl, xbr, ybu, ybd, ilg):
        ...
        if (LAXIS != 2):
            print("ERROR(TurbulentMassFluxResolutionStudy.py): Only LAXIS=2 is supported.")
            sys.exit()
