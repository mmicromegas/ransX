...
class ReadParamsRansXi:
    ...
    def getForProp(self, param):
        ...
        xbl = float(match[10].split(",")[2])
        xbr = float(match[11].split(",")[2])

        return {'code': code, 'eht_data': eht_data, 'plabel': plabel, 'prefix': prefix, 'ig': ig, 'nsdim': nsdim,
