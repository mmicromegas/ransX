...
class TemperatureEquation(Calculus, SetAxisLimit, Tools, Errors, object):
    ...
    def __init__(self, filename, ig, fext, ieos, intc, nsdim, data_prefix):
        ...
        self.plus_disstke_o_cv = np.zeros(nx)
    ...
    def plot_tt(self, laxis, bconv, tconv, xbl, xbr, ybu, ybd, ilg, xsc, ysc):
        ...
        if self.ig == 1:
            plt.plot(grd1/xsc, plt1/ysc, color='brown', label=r'T')
        elif self.ig == 2:
            plt.plot(grd1/xsc, plt1/ysc, color='brown', label=r'T')
