...
class VelocitiesMLTturb(Calculus, SetAxisLimit, Tools, Errors, object):
    ...
    def plot_velocities(self, laxis, xbl, xbr, ybu, ybd, ilg, xsc, ysc):
        ...
        plt.plot(grd1/xsc, plt8/ysc, color='blue', label=r"urms")

        plt.plot(grd1/xsc,plt5/ysc,color='red',label = r'umlt')
